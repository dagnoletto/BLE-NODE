...
/****************************************************************/
/* ACI_Hal_Get_Fw_Build_Number_Event()                         	*/
/* Purpose: Event generated by the ACI_Hal_Get_Fw_Build_Number	*/
/* command.														*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void ACI_Hal_Get_Fw_Build_Number_Event( EVENT_CODE Event, CONTROLLER_ERROR_CODES ErrorCode, uint16_t RevisionNumber )
{
...
/* Purpose: Event generated by the ACI_Hal_Write_Config_Data	*/
/* command.														*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void ACI_Hal_Write_Config_Data_Event( EVENT_CODE Event, CONTROLLER_ERROR_CODES ErrorCode )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/* Purpose: Event generated by the ACI_Hal_Read_Config_Data		*/
/* command.														*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void ACI_Hal_Read_Config_Data_Event( EVENT_CODE Event, CONTROLLER_ERROR_CODES ErrorCode, uint8_t* DataPtr, uint8_t DataSize )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* ACI_Hal_Set_Tx_Power_Level_Event()                          	*/
/* Purpose: Event generated by the ACI_Hal_Set_Tx_Power_Level	*/
/* command.														*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void ACI_Hal_Set_Tx_Power_Level_Event( EVENT_CODE Event, CONTROLLER_ERROR_CODES ErrorCode )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/* Purpose: Event generated by the ACI_Hal_Device_Standby		*/
/* command.														*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void ACI_Hal_Device_Standby_Event( EVENT_CODE Event, CONTROLLER_ERROR_CODES ErrorCode )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* ACI_Hal_LE_Tx_Test_Packet_Number_Event()                     */
/* Purpose: Event generated by 									*/
/* the ACI_Hal_LE_Tx_Test_Packet_Number command.				*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void ACI_Hal_LE_Tx_Test_Packet_Number_Event( EVENT_CODE Event, CONTROLLER_ERROR_CODES ErrorCode, uint32_t PacketCounter )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* ACI_Hal_Tone_Start_Event()                    				*/
/* Purpose: Event generated by the ACI_Hal_Tone_Start command.	*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void ACI_Hal_Tone_Start_Event( EVENT_CODE Event, CONTROLLER_ERROR_CODES ErrorCode )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* ACI_Hal_Tone_Stop_Event()                    				*/
/* Purpose: Event generated by the ACI_Hal_Tone_Stop command.	*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void ACI_Hal_Tone_Stop_Event( EVENT_CODE Event, CONTROLLER_ERROR_CODES ErrorCode )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* ACI_Hal_Get_Link_Status_Event()                 				*/
/* Purpose: Event generated by the ACI_Hal_Get_Link_Status		*/
/*  command.													*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void ACI_Hal_Get_Link_Status_Event( EVENT_CODE Event, CONTROLLER_ERROR_CODES ErrorCode, uint8_t* LinkStatus, uint8_t* Connection_Handle )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* ACI_Hal_Get_Anchor_Period_Event()               				*/
/* Purpose: Event generated by the ACI_Hal_Get_Anchor_Period	*/
/*  command.													*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void ACI_Hal_Get_Anchor_Period_Event( EVENT_CODE Event, CONTROLLER_ERROR_CODES ErrorCode, uint32_t AnchorInterval, uint32_t Maxslot )
{
	/* The user should implement at higher layers since it is weak. */
}
