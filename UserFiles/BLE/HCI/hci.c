...
uint8_t HCI_Read_Remote_Version_Information( uint16_t Connection_Handle, DefCmdStatus StatusCallBack )
{
	...
	if( Connection_Handle <= MAX_CONNECTION_HANDLE )
	{
		...
		Status = HCI_Transmit( PcktPtr, ByteArraySize, CALL_BACK_AFTER_TRANSFER, NULL, &StatusCallBack );
...
uint8_t HCI_Reset( void )
{
	...
	Status = HCI_Transmit( &Pckt, sizeof(Pckt), CALL_BACK_AFTER_TRANSFER, NULL, (CMD_CALLBACK*)&NullCmdCallBack );
...
/****************************************************************/
/* HCI_LE_Add_Device_To_White_List_Status()             		*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
/* HCI_LE_Add_Device_To_White_List command.						*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Add_Device_To_White_List_Status( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Add_Device_To_White_List_Complete()             		*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
/* HCI_LE_Add_Device_To_White_List command.						*/
/* Parameters: none				         						*/
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Add_Device_To_White_List_Complete( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Remove_Device_From_White_List_Status()             	*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
/* HCI_LE_Remove_Device_From_White_List command.				*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Remove_Device_From_White_List_Status( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Remove_Device_From_White_List_Complete()             	*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
/* HCI_LE_Remove_Device_From_White_List command.				*/
/* Parameters: none				         						*/
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Remove_Device_From_White_List_Complete( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Set_Host_Channel_Classification_Status()             	*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Set_Host_Channel_Classification_Status( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Set_Host_Channel_Classification_Complete()            */
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
/* HCI_LE_Set_Host_Channel_Classification command.				*/
/* Parameters: none				         						*/
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Set_Host_Channel_Classification_Complete( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Connection_Update_Status()            				*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Connection_Update_Status( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Read_Channel_Map_Status()            					*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
/* HCI_LE_Read_Channel_Map command.								*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Read_Channel_Map_Status( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Read_Channel_Map_Complete()            				*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
/* HCI_LE_Read_Channel_Map command.								*/
/* Parameters: none				         						*/
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Read_Channel_Map_Complete( CONTROLLER_ERROR_CODES Status, uint16_t Connection_Handle, CHANNEL_MAP* Channel_Map )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Read_Remote_Features_Status()            				*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
/* HCI_LE_Read_Remote_Features command.							*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Read_Remote_Features_Status( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Encrypt_Status( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Encrypt_Complete( CONTROLLER_ERROR_CODES Status, uint8_t Encrypted_Data[16] )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Rand_Status( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Rand_Complete( CONTROLLER_ERROR_CODES Status, uint8_t Random_Number[8] )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Enable_Encryption_Status()   							*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
/* HCI_LE_Enable_Encryption command.							*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Enable_Encryption_Status( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Long_Term_Key_Request_Reply_Status()   				*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Long_Term_Key_Request_Reply_Status( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Long_Term_Key_Request_Reply_Complete()   				*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
/* HCI_LE_Long_Term_Key_Request_Reply command.					*/
/* Parameters: none				         						*/
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Long_Term_Key_Request_Reply_Complete( CONTROLLER_ERROR_CODES Status, uint16_t Connection_Handle )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Long_Term_Key_Request_Negative_Reply_Status()   		*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
/* HCI_LE_Long_Term_Key_Request_Negative_Reply command.			*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Long_Term_Key_Request_Negative_Reply_Status( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Long_Term_Key_Request_Negative_Reply_Complete()   	*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
/* HCI_LE_Long_Term_Key_Request_Negative_Reply command.			*/
/* Parameters: none				         						*/
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Long_Term_Key_Request_Negative_Reply_Complete( CONTROLLER_ERROR_CODES Status, uint16_t Connection_Handle )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Read_Supported_States_Status()   						*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
/* HCI_LE_Read_Supported_States command.						*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Read_Supported_States_Status( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Read_Supported_States_Complete()   					*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
/* HCI_LE_Read_Supported_States command.						*/
/* Parameters: none				         						*/
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Read_Supported_States_Complete( CONTROLLER_ERROR_CODES Status, SUPPORTED_LE_STATES* LE_States )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Receiver_Test_v1_Status()   							*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
/* HCI_LE_Receiver_Test_v1 command.								*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Receiver_Test_v1_Status( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Receiver_Test_v1_Complete()   						*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
/* HCI_LE_Receiver_Test_v1 command.								*/
/* Parameters: none				         						*/
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Receiver_Test_v1_Complete( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Transmitter_Test_v1_Status()   						*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
/* HCI_LE_Transmitter_Test_v1 command.							*/
/* Parameters: none				         						*/
/* Return: none  												*/
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Transmitter_Test_v1_Status( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/****************************************************************/
/* HCI_LE_Transmitter_Test_v1_Complete()   						*/
/* Location: 					 								*/
/* Purpose: Event generated by the 								*/
/* HCI_LE_Transmitter_Test_v1 command.							*/
/* Parameters: none				         						*/
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Transmitter_Test_v1_Complete( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Test_End_Status( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_LE_Test_End_Complete( CONTROLLER_ERROR_CODES Status )
{
	/* The user should implement at higher layers since it is weak. */
}
