...
/****************************************************************/
/* HCI_Read_Local_Version_Information_Response()                */
...
/* Description:													*/
/****************************************************************/
__attribute__((weak)) void HCI_Read_Local_Version_Information_Response( EVENT_CODE Event, CONTROLLER_ERROR_CODES ErrorCode )
{
	/* The user should implement at higher layers since it is weak. */
}
